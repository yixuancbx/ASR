...
def create_vox2video_dataset_from_list(train_list,
    ...
    train_dataset = Vox2VideoDatasetFromList(
        ...
        use_musan_noise=use_musan_noise,
        musan_root=musan_root,
        musan_apply_prob=musan_apply_prob,
        musan_snr_min_db=musan_snr_min_db,
        musan_snr_max_db=musan_snr_max_db,
        musan_noise_weight=musan_noise_weight,
        musan_speech_weight=musan_speech_weight,
        musan_music_weight=musan_music_weight,
        disable_audio_time_aug_for_avsync=disable_audio_time_aug_for_avsync,
        use_face_roi=use_face_roi,
        face_roi_expand_ratio=face_roi_expand_ratio,
        face_roi_smooth_alpha=face_roi_smooth_alpha,
        face_roi_score_thr=face_roi_score_thr,
